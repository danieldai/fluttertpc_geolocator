...
/// Represents different Ohos specific settings with which you can set a value
/// other then the default value of the setting.
class OhosSettings extends LocationSettings {
  /// Initializes a new [OhosSpecificSettings] instance with default values.
  ///
  ...
  /// the FusedLocationProviderClient (Ohos only).
  ///
  ...
  /// following code to your `Ohos/app/build.gradle` file:
  /// ```gradle
  /// configurations.implementation {
  ///   exclude group: 'com.google.Ohos.gms'
  /// }
  /// ```
  ...
  /// increases the priority of your activity making it less likely for Ohos to kill the activity
  /// when switching between apps. It does not prevent Ohos from killing the activity. If you want to
  ...
  /// this property true will help to align Ohos altitude to that of iOS which uses MSL.
  ///
  /// If the NMEA message is empty then the altitude reported will still be the standard WSG84
  /// altitude from the GPS receiver.
  ///
  /// MSL Altitude is only available starting from Ohos N and not all devices support
