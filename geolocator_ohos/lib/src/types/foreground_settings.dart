/// Uniquely identifies an Ohos resource.
class OhosResource {
  ...
  /// Uniquely identifies an Ohos resource.
  const OhosResource({required this.name, this.defType = 'drawable'});
...
class ForegroundNotificationConfig {
  ...
  /// Creates an Ohos specific configuration for the [FlutterBackground] plugin.
  ///
  ...
  /// it should be of value `OhosResource(name: 'background_icon', defType: 'drawable').
