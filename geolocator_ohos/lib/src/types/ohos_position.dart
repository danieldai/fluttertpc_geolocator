...
/// Contains additional location information only available on Ohos platforms.
@immutable
class OhosPosition extends Position {
  /// Constructs an instance with the given values for testing. [OhosPosition]
  ...
  /// Converts the supplied [Map] to an instance of the [OhosPosition] class.
  ...
  /// Converts the [OhosPosition] instance into a [Map] instance that can be
  /// serialized to JSON.
  @override
